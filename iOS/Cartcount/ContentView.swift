        ...
        NavigationStack {
            Form {
                ...
                TextField("Total", value: $draft.total, format: .number)
                    ...
                    .accessibilityIdentifier("field_total")

                DatePicker("Trip date", selection: $draft.tripDate, displayedComponents: .date)
                    .accessibilityIdentifier("field_tripDate")

                TextField("Item count", value: $draft.itemCount, format: .number)
                    .keyboardType(.numberPad)
                    .accessibilityIdentifier("field_itemCount")
